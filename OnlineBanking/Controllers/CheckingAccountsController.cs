...
namespace OnlineBanking.Controllers
{
    ...
    {
        public CheckingAccountsController()
        {
        }
        ...
        {
            var checkingAccounts = db.CheckingAccounts.Include(c => c.Account);
        ...
        public ActionResult Create([Bind(Include = "CheckingAccountID,Deposit,Withdraw,CheckingAccountType,AccountID")] CheckingAccount checkingAccount)
        {
            ...
            ViewBag.AccountID = new SelectList(db.Accounts, "AccountID", "AccountType", checkingAccount.AccountID);
            return View(checkingAccount);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CheckingAccountID,Deposit,Withdraw,CheckingAccountType,AccountID")] CheckingAccount checkingAccount)
        {
            if (ModelState.IsValid)
            {
